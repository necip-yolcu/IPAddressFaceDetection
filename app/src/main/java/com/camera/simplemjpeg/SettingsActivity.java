...
public class SettingsActivity extends Activity {
    ...
    RadioButton rad_btn_andr, rad_btn_ip;

    Spinner resolution_spinner;
    EditText cam_input, width_input, height_input, address1_input, address2_input, address3_input, address4_input, port_input, command_input;

    RadioGroup port_group, command_group;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rad_btn_andr = findViewById(R.id.r_b_andr);
        rad_btn_ip = findViewById(R.id.r_b_ip);

        cam_input = findViewById(R.id.cam_input);
        ...
        command_group = findViewById(R.id.command_radiogroup);

        if (extras != null) {
            cmr_inp = extras.getInt("cmr_inp", cmr_inp);
            ...
            cam_input.setText(String.valueOf(cmr_inp));
        ...
        port_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if(checkedId == R.id.r_b_andr){
                    cam_input.setText("1");
                }else if(checkedId == R.id.r_b_ip){
                    cam_input.setText("2");
                }
            }
        });
        ...
        settings_done.setOnClickListener(
                new View.OnClickListener() {
                    public void onClick(View view) {
                        ...
                        s = cam_input.getText().toString();
                        if (!"".equals(s))
                            cmr_inp = Integer.parseInt(s);
                        ...
                        intent.putExtra("cmr_inp", cmr_inp);
